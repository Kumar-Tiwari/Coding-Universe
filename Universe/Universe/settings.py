...
SECRET_KEY = 'g)=honee25e)1mupyxotgy8d29f6^csemd%y(3k0se85x*io*e'
...
from .email import User_email,User_password
...
ALLOWED_HOSTS = ['192.168.16.109', 'localhost', '127.0.0.1']
